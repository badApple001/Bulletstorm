//==========================
// - FileName:      Assets/Frameworks/Scripts/Debugger/Base/Utility/Utility.Converter.cs
// - Created:       ChenJC	
    ...
    public static partial class Utility
    {
        ...
        public static class Converter
        {
            ...
            public static float GetCentimetersFromPixels(float pixels)
            {
                if (ScreenDpi <= 0)
                {
                    throw new DebuggerException("You must set screen DPI first.");
                }
            ...
            public static byte[] GetBytes(string value, Encoding encoding)
            {
                if (value == null)
                {
                    throw new DebuggerException("Value is invalid.");
                }

                if (encoding == null)
                {
                    throw new DebuggerException("Encoding is invalid.");
                }
