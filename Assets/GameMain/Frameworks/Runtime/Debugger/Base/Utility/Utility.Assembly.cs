//==========================
// - FileName:      Assets/Frameworks/Scripts/Debugger/Base/Utility/Utility.Assembly.cs
// - Created:       ChenJC	
    ...
    public static partial class Utility
    {
        ...
        public static class Assembly
        {
            ...
            public static void GetTypes(List<Type> results)
            {
                if (results == null)
                {
                    throw new DebuggerException("Results is invalid.");
                }
            ...
            public static Type GetType(string typeName)
            {
                ...
                {
                    throw new DebuggerException("Type name is invalid.");
                }
