//==========================
// - FileName:      Assets/Frameworks/Scripts/Debugger/Base/ReferencePool/ReferencePool.ReferenceCollection.cs
// - Created:       ChenJC	
    ...
    public static partial class ReferencePool
    {
        private sealed class ReferenceCollection
        {
            ...
            public T Acquire<T>() where T : class, IReference, new()
            {
                ...
                {
                    throw new DebuggerException("Type is invalid.");
                }
            ...
            public void Release(IReference reference)
            {
                ...
                lock (m_References)
                {
                    ...
                    {
                        throw new DebuggerException("The reference has been released.");
                    }
