//==========================
// - FileName:      Assets/Frameworks/Scripts/Debugger/Base/ReferencePool/ReferencePool.cs
// - Created:       ChenJC	
...
namespace Debugger
{
    ...
    public static partial class ReferencePool
    {
        ...
        public static void Release(IReference reference)
        {
            if (reference == null)
            {
                throw new DebuggerException("Reference is invalid.");
            }
        ...
        private static void InternalCheckReferenceType(Type referenceType)
        {
            ...
            {
                throw new DebuggerException("Reference type is invalid.");
            }

            if (!referenceType.IsClass || referenceType.IsAbstract)
            {
                throw new DebuggerException("Reference type is not a non-abstract class type.");
            }

            if (!typeof(IReference).IsAssignableFrom(referenceType))
            {
                throw new DebuggerException(Utility.Text.Format("Reference type '{0}' is invalid.", referenceType.FullName));
            }
        }
        ...
        private static ReferenceCollection GetReferenceCollection(Type referenceType)
        {
            if (referenceType == null)
            {
                throw new DebuggerException("ReferenceType is invalid.");
            }
