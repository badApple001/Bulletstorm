//==========================
// - FileName:      Assets/Frameworks/Scripts/Debugger/Component/DebuggerComponent.cs
// - Created:       ChenJC	
...
namespace Debugger
{
    ...
    public sealed partial class DebuggerComponent : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //if( m_Skin == null )
            //{
            //    m_Skin = Resources.Load<GUISkin>( "DogDebugMode" );
            //}
        }
        ...
        private void OnGUI()
        {
            ...
            m_WindowScale = Screen.width / 860f;
            GUI.skin = m_Skin;
