...
namespace Quark.Editor
{
    ...
    internal class QuarkAssetBundleTabData
    {
        ...
        public QuarkAssetBundleTabData( )
        {
            ...
            EditorPrefs.SetString( nameof( QuarkLauncher ) + ".Encrypt.aes", AesEncryptionKeyForManifest );
            EditorPrefs.SetInt( nameof( QuarkLauncher ) + ".Encrypt.offset", EncryptionOffsetForAssetBundle );
        }
    }
