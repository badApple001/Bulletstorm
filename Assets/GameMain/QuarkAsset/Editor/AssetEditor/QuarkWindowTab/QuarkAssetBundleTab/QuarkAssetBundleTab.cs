...
namespace Quark.Editor
{
    public class QuarkAssetBundleTab
    {
        ...
        public const string AssetBundleTabDataFileName = "QuarkAsset_AssetBundleTabData.json";
        ...
        public void OnEnable( )
        {
            ...
            //tabData.StreamingRelativePath = Application.version;
        }
        ...
        void DrawAESEncryptionForBuildInfoLable( )
        {
            ...
            if ( tabData.UseAesEncryptionForManifest )
            {
                ...
                EditorGUILayout.LabelField( $"AESKey({aesKeyLength})", tabData.AesEncryptionKeyForManifest );
                GUILayout.Space( 16 );
            }
        }
        ...
        void DrawBuildSettingLabel( )
        {
            ...
            EditorGUILayout.LabelField( "StreamingRelativePath", tabData.BuildVersion?.Trim( ) );

            switch ( tabData.BuildType )
            {
                case BuildType.Full:
                    {
                        EditorGUILayout.LabelField( "Internal build version", tabData.InternalBuildVersion.ToString( ) );
        ...
        void DrawBuildPathLabel( )
        {
            GUILayout.BeginHorizontal( );
            {
                EditorGUILayout.LabelField( "Build path", tabData.BuildPath.Trim( ) );
        ...
        void DrawOffsetEncryptionForAssetBundleLable( )
        {
            ...
            {
                //EditorGUILayout.LabelField( "AssetBundle encryption offset" );
                //int offset = EditorGUILayout.IntField( "Encryption offset", tabData.EncryptionOffsetForAssetBundle );
                //if( offset != tabData.EncryptionOffsetForAssetBundle )
                //{
                //    tabData.EncryptionOffsetForAssetBundle = offset;
                //    EditorPrefs.SetInt( nameof( QuarkLauncher ) + ".Encrypt.offset", offset );
                //}
            }
        }
        void BrowseFolder( )
