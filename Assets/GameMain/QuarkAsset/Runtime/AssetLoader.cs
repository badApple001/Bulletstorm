...
where T : Object
    ...
    public static Object Load( string assetName, Type type )
    {
        return quarkLoadModeProvider.LoadAsset( assetName, type );
    }
    public static Coroutine LoadAsync<T>( string assetName, Action<T> callback )
where T : Object
    {
        return quarkLoadModeProvider.LoadAssetAsync<T>( assetName, callback );
    }
    public static Coroutine LoadAsync( string assetName, Type type, Action<Object> callback )
    {
