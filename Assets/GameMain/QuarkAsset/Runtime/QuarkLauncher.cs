...
namespace Quark
{
    ...
    public class QuarkLauncher : MonoBehaviour
    {
        ...
        ///启用 ab build 的相对路径；
        /// </summary>
        [SerializeField] bool enableStreamingRelativeBuildPath = true;
        /// <summary>
        /// ab Build 的相对地址；
        /// </summary>
        ...
        public static QuarkLauncher Ins
        {
            get
            {
                if (instance == null)
        ...
        public void LaunchWithConfig(Action onSuccess, Action<string> onFailure)
        {
            ...
            //真机模式 强制设置为SteamingAssets目录下AssetBundle加载
#if !UNITY_EDITOR
            loadMode = QuarkLoadMode.AssetBundle;
            quarkBuildPath = QuarkBuildPath.StreamingAssets;
#endif
            ...
            switch (loadMode)
            {
                case QuarkLoadMode.AssetDatabase:
                    {
                        AssetLoader.LaunchAssetDatabaseMode(quarkDataset, onSuccess, onFailure);
                    }
                    break;
                case QuarkLoadMode.AssetBundle:
                    {
                            ...
                            case QuarkBuildPath.StreamingAssets:
                                {
                                    ...
                                    streamingRelativeBuildPath = "AssetBundles";
                        ...
                        AssetLoader.LaunchAssetBundleMode(dirPath, onSuccess, onFailure, manifestAesKey, 32);
                    }
                    break;
            }
        }
        ...
        public bool OnLaunchSucceed { private set; get; } = false;

        public Action<bool> OnLaunchCallback;
